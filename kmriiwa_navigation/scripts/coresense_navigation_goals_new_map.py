...
def main():
    ...
    position_lists_to_station = [        
        ...
        #[1.80,-8.25656,0,0,0,-0.757704,0.652598], # Move to next station       

        [1.19,-1.44057,0,0,-0.99971,0.0076], # Exit station                       
        #[1.6733,2.03847,0,0,0,-0.72573,0.68798], # Assembly station with UR               
